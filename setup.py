...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-purchase_cancel_pending_moves',
    download_url='https://github.com:nantic/trytond-purchase_cancel_pending_moves.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-purchase_cancel_pending_moves.git'
    },
    classifiers=[
